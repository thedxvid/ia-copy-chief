      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        <div className="animate-fade-in-up">
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight animate-fade-in-up animate-stagger-1">
            ...
            <span className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent block mt-2 animate-fade-in-up animate-stagger-2">
              Copy Persuasiva
            </span>
          </h2>
          
          <p className="text-xl md:text-2xl lg:text-3xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-in-up animate-stagger-3">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 animate-fade-in-up animate-stagger-4">
            <ModernButton asChild size="lg" variant="gradient" className="group modern-button bg-gradient-to-r from-blue-600 to-purple-600 text-white text-lg px-12 py-4">
            ...
            <ModernButton variant="glass" size="lg" asChild className="modern-button bg-white/10 text-white border-white/20 hover:bg-white/20 text-lg px-8 py-4">
              <Link to="/dashboard">
                Ver Dashboard
              </Link>
            </ModernButton>
